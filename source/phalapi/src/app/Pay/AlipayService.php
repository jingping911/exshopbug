...
class AlipayService
{
    ...
    public function __construct()
    {
        ...
        //$this->gatewayUrl = $ali_config['gatewayUrl']; // 网关地址 沙箱与正式的不同 请区分填写
    }
    ...
    {
        $this->passbackParams = $passback_params;
    }
    ...
    public function doPay()
    {
        ...
        $requestConfigs = array(
            ...
            'quit_url' => $this->quitUrl, // 支付中断跳转
            'passback_params' => $this->passbackParams, // 原样返回的参数
        );
        $commonConfigs = array(
            //公共参数
            'app_id' => $this->appId,
