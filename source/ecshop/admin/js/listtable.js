 ...
 * 获取界面信息
 */
listTable.target_cata = function(act)
{

  Ajax.call(this.url, "act="+act, this.enterprise, "GET", "JSON");

}
listTable.enterprise = function(result)
{
  var frm = document.forms['listForm'];
  frm.elements['target_cat'].innerHTML = result.content;
}
/**
 * 删除列表中的一个记录
 */
