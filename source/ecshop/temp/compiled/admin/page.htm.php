...
<div id="turn-page">
  <span id="pageCurrent"><?php echo $this->_var['filter']['page']; ?></span> / <span id="totalPages"><?php echo $this->_var['page_count']; ?></span>
  页，每页 <input type='text' size='3' id='pageSize' value="<?php echo $this->_var['filter']['page_size']; ?>" onkeypress="return listTable.changePageSize(event)">
  条记录，总共 <span id="totalRecords"><?php echo $this->_var['record_count']; ?></span>
  条记录
  <span id="page-link">
